...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__move_move__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__wheel_callback_js__ = __webpack_require__(8);
...
window.onload=function () {
  ...
  if(contentNode.addEventListener){
    contentNode.addEventListener("DOMMouseScroll",(event)=>{
      clearTimeout(tiemr)
      tiemr = setTimeout(()=>{
        Object(__WEBPACK_IMPORTED_MODULE_1__wheel_callback_js__["a" /* default */])(event,contentNode.index)
      },50)
    })
  }
